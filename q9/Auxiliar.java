...
public class Auxiliar {
	...
	public static void relatorio() {
		System.out.println("Quantidade de pacientes: " + Auxiliar.qtdpacientes);
		System.out.println("Média de idade dos homens: " + Auxiliar.mediaidadehomem);
		...
		System.out.println("A quantidade de pessoa com idade entre 18 e 25 anos: "
				+ Auxiliar.pessoas);
		System.out.println("Nome do paciente mais velho: " + Auxiliar.nomemaisvelho);
		System.out.println("Nome da paciente mais baixa: " + Auxiliar.nomemaisbaixa);
	}
