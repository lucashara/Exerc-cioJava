...
public class Auxiliar {
	...
	public Auxiliar(String clientenome, int clientedias) {
		nome = clientenome;
		dias = clientedias;
	}
	...
	public float geraConta() {
		if(getDias() < 10) {
			...
			return Auxiliar.lucropousada = Auxiliar.lucropousada + contacliente;
		}
		else {
	...
	public static void geraLucro() {
		System.out.println("O lucro total da pousada foi de: " + Auxiliar.lucropousada);
	}
}